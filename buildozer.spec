...
version = 1.0
requirements = python3==3.11.9,hostpython3==3.11.9,kivy==2.3.1,supabase==2.27.0,postgrest,gotrue,realtime,storage3,httpx,httpcore,h11,h2,hpack,hyperframe,websockets,yarl,multidict,attrs,idna,anyio,sniffio,certifi,charset-normalizer,typing-extensions,pydantic,deprecation,pyjnius==1.7.0
